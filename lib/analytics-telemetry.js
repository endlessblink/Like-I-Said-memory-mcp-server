...
class AnalyticsCollector {
    ...
    loadConfig() {
        try {
            ...
            console.error('Analytics config not found, creating default...');
        }
    ...
    async sendEvent(event) {
        if (process.env.NODE_ENV === 'test') {
            console.error('Analytics event (test mode):', event);
            return;
        }
    ...
    // Removed deprecated DXT installation tracking
...
// Removed deprecated DXT installation export
