...
class UnifiedMemoryStorage {
  ...
  async addMemory(content, project = 'default', category, tags, priority) {
    ...
    // Also save to legacy format for backward compatibility (optional)
    const legacyResult = await this.legacyStorage.addMemory(content, project, category, tags, priority);
...
class UnifiedTaskStorage {
  ...
  async createTask(data) {
    ...
    const legacyResult = await this.legacyStorage.createTask(data);
